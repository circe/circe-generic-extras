 ...
 *
 * Extend this trait for creating [[io.circe.Decoder]] and [[io.circe.Encoder.AsObject]] instances for case classes,
 * "incomplete" case classes, sealed trait hierarchies, etc.
 */
